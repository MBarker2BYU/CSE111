...
def test_water_column_height():
    ...
    validate_float_type('water_column_height', water_column_height(0.0, 0.0))
...
def test_pressure_gain_from_water_height():
    ...
    validate_float_type('pressure_gain_from_water_height', pressure_gain_from_water_height(0.0))
...
def test_pressure_loss_from_pipe():
    ...
    validate_float_type('pressure_loss_from_pipe', pressure_loss_from_pipe(0.0, 0.0, 0.0, 0.0))
...
def test_pressure_loss_from_fittings():
    ...
    # result = pressure_loss_from_pipe(0.0, 0.0, 0.0, 0.0)
    # assert isinstance(result, float), F"{test_pressure_loss_from_fittings} function must return a float"

    validate_float_type('pressure_loss_from_fittings', pressure_loss_from_fittings(0.0, 0.0))
...
def test_reynolds_number():
    ...
    validate_float_type('reynolds_number', reynolds_number(0.0, 0.0))

    return 0.0

def test_pressure_loss_from_pipe_reduction():

    validate_float_type('pressure_loss_from_pipe_reduction', pressure_loss_from_pipe_reduction(0.0, 0.0, 0.0, 0.0))
